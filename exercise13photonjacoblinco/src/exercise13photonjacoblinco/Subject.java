...
public class Subject {
    ...
    protected static Subject currentDisplay;
    ...
    public static Subject getCurrentDisplay() {
        return currentDisplay;
    }
    
    public static void setCurrentDisplay(Subject currentDisplay) {
        Subject.currentDisplay = currentDisplay;
    }
